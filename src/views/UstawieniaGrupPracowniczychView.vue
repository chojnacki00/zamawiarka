...
.form-field input, .form-field textarea { width: 100%; box-sizing: border-box; padding: 13px; border: 1px solid #d1d5db; border-radius: 11px; font: inherit; font-size: 16px; text-transform: none; }
